...
public class slti extends ITypeInstruction {
    public slti(Register rd, Register rs1, Immediate immediate, ITypeMetadata meta, State state) {
        super("slti", rd, rs1, immediate, meta, state);
    }
